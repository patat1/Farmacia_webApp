...
<div class="section">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1 class="text-center">Iscrizione di ${session.newuser} completata</h1>
            </div>
        </div>
        <div class="row">
            <div class="col-md-4"></div>
            <div class="col-md-4">
                <a class="btn btn-block btn-lg btn-success" href="/Farmacia_WebApp/">Torna alla Home del Sito<i class="fa fa-check fa-fw"></i></a>
            </div>
            <div class="col-md-4"></div>
        </div>
    </div>
