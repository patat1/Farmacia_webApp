            ...
            <div class="col-md-12">
                <form class="form-horizontal" role="form" action="subTF" controller="SubscriberMasterController.groovy">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="password" class="form-control" id="password" placeholder="Password" name="passworda">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-2">
                        ...
                        <div class="col-sm-10">
                            <input type="password" class="form-control" id="passwordControl" placeholder="Password" name="passwordb">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-2">
                            <label for="street" class="control-label">Indirizzo completo</label>
                        </div>
                        <div class="col-sm-10">
